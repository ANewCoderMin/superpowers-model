...
The headline change is **skills repository separation**: all skills, scripts, and documentation have moved from the plugin into a dedicated repository ([https://github.com/ANewCoderMin/superpowers-model.git](https://github.com/ANewCoderMin/superpowers-model.git)). This transforms superpowers from a monolithic plugin into a lightweight shim that manages a local clone of the skills repository. Skills auto-update on session start. Users fork and contribute improvements via standard git workflows. The skills library versions independently from the plugin.
...
**The biggest change:** Skills no longer live in the plugin. They've been moved to a separate repository at [https://github.com/ANewCoderMin/superpowers-model.git](https://github.com/ANewCoderMin/superpowers-model.git).
...
3. Fresh clone of https://github.com/ANewCoderMin/superpowers-model.git will be created at `~/.config/superpowers/skills/`
...
- Clones https://github.com/ANewCoderMin/superpowers-model.git on first run
...
- Prominent link to https://github.com/ANewCoderMin/superpowers-model.git
...
**Removed:**
- `skills/` directory (82 files) - Now in https://github.com/ANewCoderMin/superpowers-model.git
- `scripts/` directory - Now in https://github.com/ANewCoderMin/superpowers-model.git/skills/using-skills/
...
```bash
# In Claude Code
/plugin marketplace add https://github.com/ANewCoderMin/superpowers-model.git
/plugin install https://github.com/ANewCoderMin/superpowers-model.git
```
...
- Skills repository is now at https://github.com/ANewCoderMin/superpowers-model.git
...
**Full Changelog:** https://github.com/ANewCoderMin/superpowers-model.git
**Skills Repository:** https://github.com/ANewCoderMin/superpowers-model.git
**Issues:** https://github.com/ANewCoderMin/superpowers-model.git
